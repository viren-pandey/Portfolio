    ...
    <div className="p-4 sm:p-8">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="mb-4 p-4 rounded-2xl border border-blue-500/20 bg-blue-500/5 flex items-start gap-3">
            <Radio size={16} className="text-blue-400 mt-0.5 shrink-0" />
            <p className="text-xs text-gray-400">Visitors must allow alerts once in the browser permission prompt. On mobile, notifications are shown while the site is open in browser/PWA.</p>
          </div>
