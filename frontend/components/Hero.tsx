        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <motion.button
              ...
              className="px-8 py-4 bg-gray-900 dark:bg-white text-white dark:text-black font-bold rounded-2xl flex items-center space-x-2 shadow-xl shadow-purple-500/20 transition-shadow"
            >
            ...
            <motion.button
              ...
              className="px-8 py-4 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-gray-900 dark:text-white font-bold rounded-2xl flex items-center space-x-2 backdrop-blur-sm hover:bg-black/10 dark:hover:bg-white/10 transition-colors"
            >
              <Terminal size={20} />
